    ...
    return (
        ...
        <div>
            ...
            <div className='bg-white rounded-lg text-center h-full p-4 '>
                ...
                <TextField id="outlined-basic" label="Fichier pdf" accept="application/pdf" type='file' variant="outlined" {...register("file", {required:"Veuillez inserer un document", accept:"application/pdf" })} />
